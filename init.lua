...
vim.keymap.set('n', '<leader>tn', ':lua vim.wo.number = not vim.wo.number<CR>', { desc = 'Toggle line [N]umbering', silent = true })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          layout_config = {
            horizontal = { width = 0.95, preview_width = 0.55 }, -- XXX
          },
        },
        extensions = {
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      --XXX   if disable_filetypes[vim.bo[bufnr].filetype] then
      --XXX     return nil
      --XXX   else
      --XXX     return {
      --XXX       timeout_ms = 500,
      --XXX       lsp_format = 'fallback',
      --XXX     }
      --XXX   end
      --XXX end,
      formatters_by_ft = {
